...
class EventForm(FlaskForm):
    ...
    startDateTime = DateTimeField('Start Open Booking Time', validators=[InputRequired()])
    endDateTime = DateTimeField('Close Open Booking Time', validators=[InputRequired()])
...
class LoginForm(FlaskForm):
    user_name = StringField("User Name", validators=[InputRequired('Enter user name')], format='%Y-%m-%d')
    password = PasswordField("Password", validators=[InputRequired('Enter user password')], format='%Y-%m-%d')
